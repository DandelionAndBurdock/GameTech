// Experiment try and make a jelly cuboid from several "cloth"
// sides with additional distance constraints across the diagonals
#pragma once
...
class Jelly {
public:
	Jelly(int dimension = DEFAULT_GRID_SIZE, float length = DEFAULT_LENGTH);
	~Jelly();
...
//#include "Cloth.h"
//class Jelly : public Mesh //Should really derive cloth and jelly from same soft body class
//{
//public:
//	Jelly(GLint dimension = DEFAULT_GRID_SIZE,
